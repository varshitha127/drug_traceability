...
RENDER_EXTERNAL_HOSTNAME = '22e47c6b1e833b107be7ed471463aaf4'
...
# Custom user model
AUTH_USER_MODEL = 'DrugTraceApp.User'
...
if not BLOCKCHAIN_PRIVATE_KEY and not DEBUG:
    raise ValueError("BLOCKCHAIN_PRIVATE_KEY environment variable is required in production")
